...
class IncidentTestCase(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.connection = BasicSnowConnection(
            self.base_url, self.snow_usr, self.snow_pwd
        )
    ...
    def test_monitor_for_new_incidents(self):
        ...
        resp_two = monitor_for_new_incidents(
            connection=self.connection, query=test_query_two
        )
